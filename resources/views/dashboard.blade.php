...
<main class="px-4 py-4">
    ...
    <section class="menu-grid">
        ...
        <div class="glass card-hover p-3 p-md-4 shadow-sm animate-fade-in-up animate-delay-100 rounded-3">
            <a href="{{ route('reports-warehouse') }}" class="d-flex text-decoration-none flex-column align-items-center text-center h-100">
        ...
        <div class="glass card-hover p-3 p-md-4 shadow-sm animate-fade-in-up animate-delay-300">
            <a href="{{ route('items-edit') }}" class="d-flex text-decoration-none flex-column align-items-center text-center h-100">
                <div class="icon-container">
        ...
        <div class="glass card-hover p-3 p-md-4 shadow-sm animate-fade-in-up animate-delay-400">
            <a href="{{route('register-item')}}" class="d-flex text-decoration-none flex-column align-items-center text-center h-100">
                <div class="icon-container">
        ...
        <div class="glass card-hover p-3 p-md-4 shadow-sm animate-fade-in-up animate-delay-500">
            <a href="{{ route('create-barcode') }}" class="text-decoration-none d-flex flex-column align-items-center text-center h-100">
                <div class="icon-container">
        ...
        <div class="glass card-hover p-3 p-md-4 shadow-sm animate-fade-in-up animate-delay-600">
            <a href="{{ route('Casher-coin') }}" class="d-flex text-decoration-none flex-column align-items-center text-center h-100">
                <div class="icon-container">
        ...
        <div class="glass card-hover p-3 p-md-4 shadow-sm animate-fade-in-up animate-delay-700">
            <a href="{{ route('items-loans.index') }}" class="d-flex text-decoration-none flex-column align-items-center text-center h-100">
                <div class="icon-container">
        ...
        <div class="glass card-hover p-3 p-md-4 shadow-sm animate-fade-in-up animate-delay-800">
            <a href="{{ route('sales.index') }}" class="d-flex text-decoration-none flex-column align-items-center text-center h-100">
                <div class="icon-container">
        ...
        <div class="glass card-hover p-3 p-md-4 shadow-sm animate-fade-in-up animate-delay-1000">
            <a href="{{ route('stock.index') }}" class="d-flex text-decoration-none flex-column align-items-center text-center h-100">
        ...
        <div class="glass card-hover p-3 p-md-4 shadow-sm animate-fade-in-up animate-delay-800">
            <a href="{{ route('create.daily.accounting') }}" class="d-flex text-decoration-none flex-column align-items-center text-center h-100">
                <div class="icon-container">
