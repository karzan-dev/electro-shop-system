        ...
        <div>
            ...
            <div class="form-card">
                ...
                <div style="display: flex; flex-direction: column; gap: 12px; margin-top: 20px;">
                    ...
                    <a href="{{ route('debtors.index') }}" class="btn btn-primary btn-block">
                        <i class="fas fa-list"></i> بینینی لیستی قەرزەکان
                    </a>
                    <a href="{{ route('sales-credit.index') }}" class="btn btn-warning btn-block">
...
function saveCredit() {
    ...
    $.ajax({
        url: '{{ route("debtors.save-products") }}',
        type: 'POST',
        data: formData,
        beforeSend: function() {
