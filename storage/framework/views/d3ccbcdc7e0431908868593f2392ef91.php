...
<title><?php echo e(config('app.name', 'Laravel')); ?> - لیستی قەرزەکان</title>
...
function loadDebtors() {
    ...
    $.ajax({
        url: '<?php echo e(route("debtors.list")); ?>',
        type: 'GET',
        data: {
            page: currentPage,
            search: search,
...
function processPayment(debtorId, amount, paymentType, laterDate = null, laterNote = '') {
    ...
    $.ajax({
        url: '<?php echo e(route("debtors.pay")); ?>',
        type: 'POST',
        data: data,
        beforeSend: function() {
...
function loadPaymentHistory(debtorId) {
    $.ajax({
        url: '<?php echo e(route("debtors.payment-history")); ?>',
        type: 'GET',
        data: {
            debtor_id: debtorId,
            _token: '<?php echo e(csrf_token()); ?>'
...
<?php echo $__env->make('layouts.navigation', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamnp64\www\mobileHardy\resources\views/items/items-loans.blade.php ENDPATH**/ ?>