...
function addToStore() {
    ...
    $.ajax({
        ...
        type: 'POST',
        data: { product_id: productId, quantity: quantity, _token: $('meta[name="csrf-token"]').attr('content') || '<?php echo e(csrf_token()); ?>' },
        success: function(response) {
...
function addToCriticalList() {
    ...
    $.ajax({
        ...
        type: 'POST',
        data: { product_id: productId, _token: $('meta[name="csrf-token"]').attr('content') || '<?php echo e(csrf_token()); ?>' },
        success: function(response) {
...
<?php echo $__env->make('layouts.navigation', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamnp64\www\mobileHardy\resources\views/items/report/reports-warehouse.blade.php ENDPATH**/ ?>