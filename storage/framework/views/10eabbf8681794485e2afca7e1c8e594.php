...
<title><?php echo e(config('app.name', 'Laravel')); ?> - فرۆشتن</title>
    ...
    <div class="print-receipt">
        <div class="print-header">
            ...
            <div class="print-cashier">
                فرۆشیار: <?php echo e(Auth::user()->name ?? 'کارمەند'); ?>
...
<div class="sales-container">
    <div class="form-header-custom text-white">
        ...
        <div style="display: flex; gap: 12px; justify-content: center; margin-top: 16px; flex-wrap: wrap;">
            <a href="<?php echo e(route('sales-credit.index')); ?>" class="btn-credit" style="width: auto; padding: 8px 16px;">
...
function searchAndHandleBarcode(barcode) {
    ...
    $.ajax({
        url: '/products/search-by-barcode',
        type: 'POST',
        data: { search_term: barcode, _token: '<?php echo e(csrf_token()); ?>' },
        success: function(res) {
...
<?php echo $__env->make('layouts.navigation', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamnp64\www\mobileHardy\resources\views/items/items-salles.blade.php ENDPATH**/ ?>