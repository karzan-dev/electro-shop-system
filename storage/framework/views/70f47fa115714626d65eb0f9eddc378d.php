...
<header class="glass sticky-top">
        ...
        <div class="row align-items-center g-0">
            ...
            <div class="col-4 col-md-8 col-lg-7 d-flex justify-content-center align-items-center">
                ...
                <div class="desktop-buttons d-none d-md-flex gap-2 align-items-center">
                    ...
                    <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-outline-custom btn-responsive">
    ...
    <div class="mobile-menu" id="mobileMenu">
        <div class="d-flex flex-column">
            ...
            <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-outline-custom btn-responsive mb-2">
                <i class="fas fa-home me-2"></i>
                ماڵەوە
            </a>

            <form action="<?php echo e(route('logout')); ?>" method="POST" class="w-100 mb-2">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\wamnp64\www\mobileHardy\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>